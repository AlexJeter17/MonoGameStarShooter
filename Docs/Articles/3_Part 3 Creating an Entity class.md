...
Continuing from [Part 2: Handling Sprites](/Z-_zLtMKQciOXvZVlCxrVA), this section will go over how to create a abstract Entity class that will represent all the objects in the game. This includes the player, enemies, and bullets.
...
In the next section [Part 3: Entity Manager!](https://hackmd.io/@Qw7rsJtWT3ih1LbsTwq8XA/HybW2cbpc) you will create a managing class for all entities in the game!
